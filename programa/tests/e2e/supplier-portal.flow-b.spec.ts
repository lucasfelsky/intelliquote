 ...
 *      submete a resposta;
 *   4. idempotencia: segunda resposta com o mesmo token leva 409.
 *
...
seededTest('Fluxo B: dispatch -> magic-link -> resposta do fornecedor -> 409 na segunda', async ({ request }) => {
  ...
  // --- 8. token vira read-only e segunda resposta leva 409 ---
  ...
  expect(viewAfterBody.readOnly).toBe(true)
